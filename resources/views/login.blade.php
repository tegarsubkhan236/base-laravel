...
<head>
    ...
    <link rel="icon" href="{{asset('assets/images/shards-dashboard-logo.svg')}}">
...
<div class="wrapper">
    <div class="logo">
        <img src="{{asset('assets/images/shards-dashboards-logo.svg')}}" alt="">
    </div>
    <div class="text-center mt-4 name"> Laravel Boilerplate </div>
